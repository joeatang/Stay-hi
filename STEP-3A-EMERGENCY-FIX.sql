-- ===============================================
-- 🚨 STEP 3A: DROP THEN CREATE increment_hi_wave
-- ===============================================

-- Drop the existing increment_hi_wave function completely
DROP FUNCTION IF EXISTS increment_hi_wave() CASCADE;

-- Now create the new function with correct signature
...
SELECT 'STEP 3A CORRECTED: increment_hi_wave()' as test;
