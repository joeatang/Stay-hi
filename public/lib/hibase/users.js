...
/**
 * Update user profile (auth-aware)
 * @param {Object} updates - Profile updates (userId auto-detected from auth)
 * @returns {Object} { data, error } with updated profile or error
 */
export async function updateMyProfile(updates) {
    ...
    try {
        ...
        if (authData.isAnon || !authData.userId) {
            return {
                data: null,
                error: { message: 'Authentication required to update profile', code: 'AUTH_REQUIRED' }
            };
        }
