...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ✨ Hiffirmations Modal System (synced with dashboard-main.js)
  function getDailyHiffirmation(date=new Date()){
    ...
    const hiBoosts=["Stay Hi! Your vibe is unmatched ✨","You've got that magic today 💪","Keep shining, Hi soul! 🚀","Your energy is everything 🌟","The world is better with you in it 🌈"]; 
