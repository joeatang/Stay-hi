-- ===============================================
-- 🔧 RECOVERY: RPC FUNCTIONS ONLY (Table exists)
-- ===============================================
-- Run this since global_stats table already exists
...
DROP POLICY IF EXISTS "Only authenticated users can update stats" ON global_stats;
